                ...
                if (_fi.Exists == true)
                {
                    ...
                    while (!_sr.EndOfStream)
                    {
                        ...
                        switch (_strArr[0])
                        {
                            ...
                            case "SQL_DB_SERVER":
                                GlobalVariable.mSatoDbServer = GlobalVariable.Decrypt_data( _strArr[1].ToString().Trim());
                                break;
                            case "SQL_DB":
                                GlobalVariable.mSatoDb = GlobalVariable.Decrypt_data(_strArr[1].ToString().Trim());
                                break;
                            case "SQL_DB_USER":
                                GlobalVariable.mSatoDbUser = GlobalVariable.Decrypt_data(_strArr[1].ToString().Trim());
                                break;
                            case "SQL_DB_PASSWORD":
                                GlobalVariable.mSatoDbPassword = GlobalVariable.Decrypt_data(_strArr[1].ToString().Trim());
                                break;
                            case "LIC_INFO":
                                GlobalVariable.mMacAddress = GlobalVariable.Decrypt_data(_strArr[1].ToString().Trim());
                                break;
                            ...
                            case "PRINTER_NAME":
                                ...
                                break;
                            case "TRC_PASS":
                                GlobalVariable.mTraceOffPass = GlobalVariable.Decrypt_data(_strArr[1].ToString().Trim());
                                break;
                        }
                    }
                    _sr.Close();
