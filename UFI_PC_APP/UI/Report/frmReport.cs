    ...
    public partial class frmReport : Form
    {
        ...
        private void frmModelMaster_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                rbFGReport.Checked = true;
                rbFGReport_CheckedChanged(null, null);
        ...
        private void FGReportExportToExcel(DataGridView dg)
        {
            ...
            try
            {
                ...
                xlWorkSheet.get_Range("AQ4", "BE4").Merge(true);
                xlWorkSheet.Cells[5, 43] = "Date and Time";
                xlWorkSheet.Cells[5, 44] = "BOP. of Big Cap";
                xlWorkSheet.Cells[5, 45] = "BOP. of Element";
                xlWorkSheet.Cells[5, 46] = "Air Pressure";
                xlWorkSheet.get_Range("AT5", "AV5").Merge(true);
                xlWorkSheet.Cells[6, 46] = "Min";
                xlWorkSheet.Cells[6, 47] = "Max";
                xlWorkSheet.Cells[6, 48] = "Actual";

                xlWorkSheet.Cells[5, 49] = "Presence of Cap Oring";
                xlWorkSheet.Cells[5, 50] = "Presence of Element Oring-1";
                xlWorkSheet.Cells[5, 51] = "Presence of Element Oring-2";
                xlWorkSheet.Cells[5, 52] = "Presence of Bypass Valve";
                xlWorkSheet.Cells[5, 53] = "Element  & Cap Oiling Confirmation";
                xlWorkSheet.Cells[5, 54] = "Tightening Torque";
                xlWorkSheet.get_Range("BB5", "BD5").Merge(true);
                xlWorkSheet.Cells[6, 54] = "Min";
                xlWorkSheet.Cells[6, 55] = "Max";
                xlWorkSheet.Cells[6, 56] = "Actual";

                xlWorkSheet.Cells[5, 57] = "Result";



                ////Station No -06
                xlWorkSheet.Cells[4, 58] = " Gasket Installation & Screw Feeding";
                xlWorkSheet.get_Range("BF4", "BQ4").Merge(true);
                xlWorkSheet.Cells[5, 58] = "Date and Time";
                ...
                xlWorkSheet.Cells[6, 59] = "BOP. pkt Gasket-1"; //Interchange 02_Aug_20
                xlWorkSheet.Cells[6, 60] = "BOP. pkt Gasket-2";
                xlWorkSheet.Cells[6, 61] = "BOP. pkt Gasket-3";
                xlWorkSheet.Cells[6, 62] = "BOP. pkt Gasket-4";
                xlWorkSheet.Cells[6, 63] = "BOP. pkt Cooler";
                xlWorkSheet.Cells[6, 64] = "BOP. pkt  M6*1.25 Screw";//Interchange 02_Aug_20

                xlWorkSheet.Cells[5, 65] = "Air Pressure";
                xlWorkSheet.get_Range("BL5", "BO5").Merge(true);
                xlWorkSheet.Cells[6, 65] = "Min";
                xlWorkSheet.Cells[6, 66] = "Max";
                xlWorkSheet.Cells[6, 67] = "Actual";

                xlWorkSheet.Cells[5, 68] = "All gasket present status by CAMERA";

                xlWorkSheet.Cells[5, 69] = "Result";

                ////Station No -07
                xlWorkSheet.Cells[4, 70] = "Cooler Pre Tightening";
                xlWorkSheet.get_Range("BR4", "BW4").Merge(true);
                xlWorkSheet.Cells[5, 70] = "Date and Time";

                xlWorkSheet.Cells[5, 71] = "Air Pressure";
                xlWorkSheet.get_Range("BS5", "BU5").Merge(true);
                xlWorkSheet.Cells[6, 71] = "Min";
                xlWorkSheet.Cells[6, 72] = "Max";
                xlWorkSheet.Cells[6, 73] = "Actual";

                xlWorkSheet.Cells[5, 74] = "Screw Count(Nos)";

                xlWorkSheet.Cells[5, 75] = "Result";

                ////Station No -08
                xlWorkSheet.Cells[4, 76] = "Heat Exchanger Final Tightening";
                xlWorkSheet.get_Range("BX4", "CT4").Merge(true);
                xlWorkSheet.Cells[5, 76] = "Date and Time";

                xlWorkSheet.Cells[5, 77] = "Air Pressure";
                xlWorkSheet.get_Range("BY5", "CA5").Merge(true);
                xlWorkSheet.Cells[6, 77] = "Min";
                xlWorkSheet.Cells[6, 78] = "Max";
                xlWorkSheet.Cells[6, 79] = "Actual";

                xlWorkSheet.Cells[5, 80] = "Tightening Torque Screw 1";
                xlWorkSheet.get_Range("CB5", "CD5").Merge(true);
                xlWorkSheet.Cells[6, 80] = "Min";
                xlWorkSheet.Cells[6, 81] = "Max";
                xlWorkSheet.Cells[6, 82] = "Actual";

                xlWorkSheet.Cells[5, 83] = "Tightening Torque Screw 2";
                xlWorkSheet.get_Range("CE5", "CG5").Merge(true);
                xlWorkSheet.Cells[6, 83] = "Min";
                xlWorkSheet.Cells[6, 84] = "Max";
                xlWorkSheet.Cells[6, 85] = "Actual";

                xlWorkSheet.Cells[5, 86] = "Tightening Torque Screw 3";
                xlWorkSheet.get_Range("CH5", "CJ5").Merge(true);
                xlWorkSheet.Cells[6, 86] = "Min";
                xlWorkSheet.Cells[6, 87] = "Max";
                xlWorkSheet.Cells[6, 88] = "Actual";

                xlWorkSheet.Cells[5, 89] = "Tightening Torque Screw 4";
                xlWorkSheet.get_Range("CK5", "CM5").Merge(true);
                xlWorkSheet.Cells[6, 89] = "Min";
                xlWorkSheet.Cells[6, 90] = "Max";
                xlWorkSheet.Cells[6, 91] = "Actual";

                xlWorkSheet.Cells[5, 92] = "Tightening Torque Screw 5";
                xlWorkSheet.get_Range("CN5", "CP5").Merge(true);
                xlWorkSheet.Cells[6, 92] = "Min";
                xlWorkSheet.Cells[6, 93] = "Max";
                xlWorkSheet.Cells[6, 94] = "Actual";

                xlWorkSheet.Cells[5, 95] = "Tightening Torque Screw 6";
                xlWorkSheet.get_Range("CQ5", "CS5").Merge(true);
                xlWorkSheet.Cells[6, 95] = "Min";
                xlWorkSheet.Cells[6, 96] = "Max";
                xlWorkSheet.Cells[6, 97] = "Actual";

                xlWorkSheet.Cells[5, 98] = "Result";

                ////Station No -09
                xlWorkSheet.Cells[4, 99] = "Anti drain leak testing";
                xlWorkSheet.get_Range("CU4", "DE4").Merge(true);
                xlWorkSheet.Cells[5, 99] = "Date and Time";

                xlWorkSheet.Cells[6, 100] = "BOP. Gasket Clean/Dirty Oil";
                xlWorkSheet.Cells[6, 101] = "BOP. Gasket Oil Drain Out";
                xlWorkSheet.Cells[6, 102] = "BOP. Gasket Coolent Outlet";

                xlWorkSheet.Cells[5, 103] = "Test Pressure";
               xlWorkSheet.get_Range("CY5", "DA5").Merge(true);
                xlWorkSheet.Cells[6, 103] = "Min";
                xlWorkSheet.Cells[6, 104] = "Max";
                xlWorkSheet.Cells[6, 105] = "Actual";

                xlWorkSheet.Cells[5, 106] = "Leak Flow Rate";
                xlWorkSheet.get_Range("DB5", "DD5").Merge(true);
                xlWorkSheet.Cells[6, 106] = "Min";
                xlWorkSheet.Cells[6, 107] = "Max";
                xlWorkSheet.Cells[6, 108] = "Actual";
                ...
                xlWorkSheet.Cells[5, 109] = "Result";

                ////Station No -10
                xlWorkSheet.Cells[4, 110] = "Dry leak testing";
                xlWorkSheet.get_Range("DF4", "DP4").Merge(true);
                xlWorkSheet.Cells[5, 110] = "Date and Time";

                xlWorkSheet.Cells[5, 111] = "Water Pressure (kpa)";
                xlWorkSheet.Cells[5, 112] = "Water Leakage (cm/mm)";
                xlWorkSheet.Cells[5, 113] = "Service Pressure (kap)";
                xlWorkSheet.Cells[5, 114] = "Service Leakage (cm/mm)";
                xlWorkSheet.Cells[5, 115] = "Oil Pressure (kpa)";
                ...
                ////Station No -11
                xlWorkSheet.Cells[4, 121] = "Final Inspection";
                xlWorkSheet.get_Range("DQ4", "DS4").Merge(true);
                xlWorkSheet.Cells[5, 121] = "Date and Time";

                xlWorkSheet.Cells[5, 122] = "Final 2D Data matrix Code";

                xlWorkSheet.Cells[5, 123] = "Result";
                ...
                for (int iBarcode = 0; iBarcode < dtFinal.Rows.Count; iBarcode++)
                {
                    ...
                    for (int i = 0; i < dgv.Rows.Count; i++)
                    {
                        ...
                        if (dgv.Rows[i].Cells[4].Value.ToString() == "05")
                        {
                            ...
                            //xlWorkSheet.Cells[iBarcode + 7, 45] = dgv.Rows[i].Cells[8].Value.ToString();  //Element BOP
                            if ( bC5hild == false)
                            {
                                int i5ChildCounter = 0;
                                for (int iChildBarcode = i; iChildBarcode < dg.Rows.Count; iChildBarcode++)
                                {
                                    bC5hild = true;
                                    i5ChildCounter = i5ChildCounter + 1;
                                    if (i5ChildCounter == 1)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 44] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode1
                                    }
                                    if (i5ChildCounter == 2)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 45] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode2
                                    }
                            ...
                            for (int j = 0; j < aParamArr.Length; j++)
                            {
                                ...
                                if (j == 2)
                                {
                                    if (char.IsNumber(aParamArr[j].ToString().Trim(), 0) && aParamArr[j].Trim() != "")
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 48] = Convert.ToString((Convert.ToDecimal(aParamArr[j].Trim()) * 1) / 100);
                                    }
                                }
                                if (j == 3)
                                {
                                ...
                                if (j == 7)
                                {
                                    xlWorkSheet.Cells[iBarcode + 7, 53] = aParamArr[j].Trim();
                                }
                                if (j == 8)
                                {
                                    if (char.IsNumber(aParamArr[j].ToString().Trim(), 0) && aParamArr[j].Trim() != "")
                                ...
                                if (j == 10)
                                {
                                    if (char.IsNumber(aParamArr[j].ToString().Trim(), 0) && aParamArr[j].Trim() != "")
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 56] = Convert.ToString((Convert.ToDecimal(aParamArr[j].Trim()) * 1) / 10);
                                    }
                                }

                            }
                            xlWorkSheet.Cells[iBarcode + 7, 57] = dgv.Rows[i].Cells[7].Value.ToString();  //Result
                            #endregion
                        }
                        if (dgv.Rows[i].Cells[4].Value.ToString() == "06")
                        {
                            #region  Staion-06
                            xlWorkSheet.Cells[iBarcode + 7, 58] = dgv.Rows[i].Cells[9].Value.ToString();  //Date Time
                            if (b6Child == false)
                            {
                                ...
                                for (int iChildBarcode = i; iChildBarcode < dg.Rows.Count; iChildBarcode++)
                                {
                                    ...
                                    if (i6ChildCounter == 1)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 59] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode1
                                    }
                                    if (i6ChildCounter == 2)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 60] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode2
                                    }
                                    if (i6ChildCounter == 3)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 61] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode3
                                    }
                                    if (i6ChildCounter == 4)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 62] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode4
                                    }
                                    if (i6ChildCounter == 5)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 63] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode5

                                    }
                                    if (i6ChildCounter == 6)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 64] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode6
                                        break;
                                    }
                                }
                            }
                            for (int j = 0; j < aParamArr.Length; j++)
                            {
                                ...
                                if (j == 2)
                                {
                                    if (char.IsNumber(aParamArr[j].ToString().Trim(), 0) && aParamArr[j].Trim() != "")
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 67] = Convert.ToString((Convert.ToDecimal(aParamArr[j].Trim()) * 1) / 100);
                                    }
                                }
                                if (j == 3)
                                {
                                    if (aParamArr[j].Trim() != "")
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 68] = Convert.ToString(aParamArr[j].Trim());
                                    }
                                }


                            }
                            xlWorkSheet.Cells[iBarcode + 7, 69] = dgv.Rows[i].Cells[7].Value.ToString();  //Result
                            #endregion
                        }
                        if (dgv.Rows[i].Cells[4].Value.ToString() == "07")
                        {
                            #region  Staion-07
                            xlWorkSheet.Cells[iBarcode + 7, 70] = dgv.Rows[i].Cells[9].Value.ToString();  //Date Time
                            ...
                            for (int j = 0; j < aParamArr.Length; j++)
                            {
                                ...
                                if (j == 2)
                                {
                                    if (char.IsNumber(aParamArr[j].ToString().Trim(), 0) && aParamArr[j].Trim() != "")
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 73] = Convert.ToString((Convert.ToDecimal(aParamArr[j].Trim()) * 1) / 100);
                                    }
                                }
                                if (j == 3)
                                {
                                    if (aParamArr[j].Trim() != "")
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 74] = Convert.ToString(aParamArr[j].Trim());
                                    }
                                }


                            }
                            xlWorkSheet.Cells[iBarcode + 7, 75] = dgv.Rows[i].Cells[7].Value.ToString();  //Result
                            #endregion
                        }
                        if (dgv.Rows[i].Cells[4].Value.ToString() == "08")
                        {
                            #region  Staion-08
                            xlWorkSheet.Cells[iBarcode + 7, 76] = dgv.Rows[i].Cells[9].Value.ToString();  //Date Time
                            ...
                            for (int j = 0; j < aParamArr.Length; j++)
                            {
                                ...
                                if (j == 2)
                                {
                                    if (char.IsNumber(aParamArr[j].ToString().Trim(), 0) && aParamArr[j].Trim() != "")
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 79] = Convert.ToString((Convert.ToDecimal(aParamArr[j].Trim()) * 1) / 100);
                                    }
                                }
                                if (j == 3)
                                {
                            ...
                            xlWorkSheet.Cells[iBarcode + 7, 98] = dgv.Rows[i].Cells[7].Value.ToString();  //Result
                            #endregion
                        }
                        if (dgv.Rows[i].Cells[4].Value.ToString() == "09")
                        {
                            #region  Staion-09
                            xlWorkSheet.Cells[iBarcode + 7, 99] = dgv.Rows[i].Cells[9].Value.ToString();  //Date Time
                            if (b9Child == false)
                            {
                                ...
                                for (int iChildBarcode = i; iChildBarcode < dg.Rows.Count; iChildBarcode++)
                                {
                                    ...
                                    if (i9ChildCounter == 1)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 100] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode1
                                    }
                                    if (i9ChildCounter == 2)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 101] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode2
                                    }
                                    if (i9ChildCounter == 3)
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 102] = dgv.Rows[iChildBarcode].Cells[8].Value.ToString();  //Child Barcode3
                                    }
                            ...
                            xlWorkSheet.Cells[iBarcode + 7, 109] = dgv.Rows[i].Cells[7].Value.ToString();  //Result
                            #endregion
                        }
                        if (dgv.Rows[i].Cells[4].Value.ToString() == "10")
                        {
                            #region  Staion-10
                            xlWorkSheet.Cells[iBarcode + 7, 110] = dgv.Rows[i].Cells[9].Value.ToString();  //Date Time
                            ...
                            for (int j = 0; j < aParamArr.Length; j++)
                            {
                                ...
                                if (j == 8)
                                {
                                    ...
                                    {
                                        xlWorkSheet.Cells[iBarcode + 7, 120] = "";
                                    }
                                }

                            }
                            xlWorkSheet.Cells[iBarcode + 7, 121] = dgv.Rows[i].Cells[7].Value.ToString();  //Result
                            #endregion
                        }
                        if (dgv.Rows[i].Cells[4].Value.ToString() == "11")
                        {
                            #region  Staion-11
                            xlWorkSheet.Cells[iBarcode + 7, 121] = dgv.Rows[i].Cells[9].Value.ToString();  //Date Time

                            xlWorkSheet.Cells[iBarcode + 7, 122] = dgv.Rows[i].Cells[8].Value.ToString();  //FG Barcode

                            xlWorkSheet.Cells[iBarcode + 7, 123] = dgv.Rows[i].Cells[7].Value.ToString();  //Result
                            #endregion
                        }
        ...
        private void rbFGReport_CheckedChanged(object sender, EventArgs e)
        {
            if (rbFGReport.Checked)
            {
                lblModelNo.Visible = true;
                cbModelNo.Visible = true;
        ...
        private void rbAssyRpt_CheckedChanged(object sender, EventArgs e)
        {
            if (rbAssyRpt.Checked)
            {
                lblModelNo.Visible = false;
                cbModelNo.Visible = false;
                lblSearchPartNo.Visible = true;
                txtPartSearch.Visible = true;
                dgv.DataSource = null;
                _RPT_Type = "";
                _RPT_Type = "ASSAY_REPORT";
            }
        }

        private void rbTraceOffRpt_CheckedChanged(object sender, EventArgs e)
        {
            if (rbTraceOffRpt.Checked)
            {
                lblModelNo.Visible = false;
                cbModelNo.Visible = false;
                lblSearchPartNo.Visible = false;
                txtPartSearch.Visible = false;
                dgv.DataSource = null;
                _RPT_Type = "";
                _RPT_Type = "TRACE_OFF_REPORT";
            }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (rbFGReport.Checked)
                {
                    ...
                    _plObj.ModelNo = cbModelNo.Text.Trim();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (rbTraceOffRpt.Checked)
                    {
                        dgv.Columns["row_num"].Visible = false;
                    }
                }
                else
                {
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (rbAssyRpt.Checked)
                {
                    SubAssyReportExportToExcel(dgv);
                }
                else if (rbTraceOffRpt.Checked)
                {
                    TraceOffReportExportToExcel(dgv);
                }
            }
            catch (Exception ex)
            {
